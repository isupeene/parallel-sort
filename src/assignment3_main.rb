...
assert(sort(a), "Sort failed.")
assert_equal(sorted_up, a, "Sort did not sort properly.")
...
assert(sort(a,timeout), "Sort failed.")
assert_equal(sorted_up, a, "Sort did not sort properly.")
...
assert(sort(a,timeout,ascending), "Sort failed.")
assert_equal(sorted_down, a, "Sort did not sort properly.")
...
assert(sort(a){|x,y| x*x < y*y}, "Sort failed.")
